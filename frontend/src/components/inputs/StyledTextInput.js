...
function StyledTextInput({errors, ...props}) {
    ...
    return (
        <div className="mb-4">
            <input
                className={"rounded-[.375rem] border shadow-input font-light box-border font-[16px] h-[56px] p-[16px] w-full border-fifth focus:outline-none focus:border-secondary " + (meta.touched && !!meta.error ? "border-red-700": "")}
                {...props}
                {...field}
            />
